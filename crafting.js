...
//        updateFighters();
    ...
    function updateQueue() {
        ...
        var time = 0;
        var craftSpeed = 1;
        if (playerGeneralService.partyService.partyInformation[myId].equipment.crafting != null) {
            craftSpeed = 1 + playerGeneralService.partyService.partyInformation[myId].equipment.crafting;
        }
